...
<p align="center">
  <img src="img/PIC.png" alt="Ayoub Photo"  style="border-radius: 10px;" />
</p>
...
- **Simple and modern navigation bar**
...
```bash
git clone https://github.com/your-username/ayoub-portfolio.git
cd ayoub-portfolio
```
